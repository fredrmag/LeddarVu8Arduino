// This file is a portion taken from the ArduinoLeddar library, created by
// LeddarTech. The full ArduinoLeddar library can be download from:
// http://share.leddartech.com/ArduinoLeddar.zip
//
// The LeddarTM Arduino Library is licensed under the terms of the MIT License,
// as is without any warranty. Copyright©LeddarTech, Inc. 2014.
//
// Full MIT licence: https://opensource.org/licenses/mit-license.html
// *****************************************************************************
...
bool CRC16(byte *aBuffer, byte aLength, bool aCheck)
{
	...
	if (aCheck)
	{
		return ( aBuffer[aLength+1] == lCRCLo ) && ( aBuffer[aLength] == lCRCHi );
	}
	else
	{
		aBuffer[aLength] = lCRCHi;
		aBuffer[aLength+1] = lCRCLo;
		return true;
	}
}
